    ...
    return (
        <div className="p-6 tablet:p-10 space-y-10">
            ...
            <div className="card-default overflow-hidden flex flex-col">
                ...
                {/* Grid Header */}
                <div className="hidden md:grid grid-cols-6 gap-6 px-8 py-4 bg-surface-container-low border-b border-outline-variant text-on-hint label-sm uppercase tracking-widest font-bold">
                ...
                <div className="divide-y divide-outline-variant bg-surface-container-lowest">
                    {filteredItems.length > 0 ? (
                                ...
                                <div className="col-span-2 flex items-center gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-on-hint text-xs">•</span>
                                            <span className="text-on-hint text-xs">{item.unit}</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-32 text-on-surface-variant/40">
                            ...
                            <p className="body-md text-on-hint max-w-xs text-center">We couldn't find any inventory items matching your current filters.</p>
                        </div>
                    )}
                </div>
            </div>
